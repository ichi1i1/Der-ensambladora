...
ON UPDATE NO ACTION;
-- REGISTRO ESTACION --
ALTER TABLE RegistroEstacion MODIFY idRegistroEstacion INT AUTO_INCREMENT;
-- -------------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------------
-- Eliminar columna modelo auto de vehiculo
-- -------------------------------------------------------------------------------
-- 1. Eliminar la FK que usa ModeloAuto_idModeloAuto
ALTER TABLE PlantaAutomotrizEnsambladora.Vehiculo
DROP FOREIGN KEY fk_Vehiculo_ModeloAuto1;

-- 2. Eliminar el índice asociado
ALTER TABLE PlantaAutomotrizEnsambladora.Vehiculo
DROP INDEX fk_Vehiculo_ModeloAuto1_idx;

-- 3. Eliminar la columna
ALTER TABLE PlantaAutomotrizEnsambladora.Vehiculo
DROP COLUMN ModeloAuto_idModeloAuto;
